module idf.esp_wifi.esp_private.wifi;
...
/**
  ...
  *
  */
enum WIFI_LOG_SUBMODULE_ALL   = 0;      /*all log submodules*/
enum WIFI_LOG_SUBMODULE_INIT  = 1;      /*logs related to initialization*/
enum WIFI_LOG_SUBMODULE_IOCTL = 1 << 1; /*logs related to API calling*/
enum WIFI_LOG_SUBMODULE_CONN  = 1 << 2; /*logs related to connecting*/
enum WIFI_LOG_SUBMODULE_SCAN  = 1 << 3; /*logs related to scaning*/

struct wifi_static_queue_t
{
...
/**
  ...
  */
int esp_wifi_internal_tx(wifi_interface_t wifi_if, void* buffer, ushort len);

/**
  * @brief     The net stack buffer reference counter callback function
  *
  */
alias wifi_netstack_buf_ref_cb_t = void function(void *netstack_buf);

/**
  * @brief     The net stack buffer free callback function
  *
  */
alias wifi_netstack_buf_free_cb_t = void function(void *netstack_buf);
...
/**
  ...
  */
esp_err_t esp_wifi_internal_wapi_init();
...
/**
  ...
  *          - ESP_OK : succeed
  */
esp_err_t esp_wifi_internal_wapi_deinit();
...
/**
  ...
  */
esp_err_t esp_wifi_internal_reg_netstack_buf_cb(wifi_netstack_buf_ref_cb_t ref_, wifi_netstack_buf_free_cb_t free);
...
/**
  ...
  */
alias wifi_rxcb_t = esp_err_t function(void* buffer, ushort len, void* eb);
...
/**
  ...
  *     - others: fail
  */
esp_err_t esp_smartconfig_internal_stop();
...
/**
  ...
  */
alias wifi_mac_time_update_cb_t = esp_err_t function(uint time_delta);
...
/**
  ...
  * @return    Always returns ESP_OK
  */
esp_err_t esp_wifi_internal_update_mac_time(uint time_delta);
...
/**
  ...
  *    - ESP_ERR_INVALID_ARG: invalid argument
  */
esp_err_t esp_wifi_internal_set_log_mod(wifi_log_module_t module_, uint submodule, bool enable);
...
/**
  ...
  *    - ESP_OK: succeed
  */
esp_err_t esp_wifi_internal_get_config_channel(wifi_interface_t ifx, ubyte* primary, ubyte* second);
...
/**
  ...
  *    - ESP_OK: succeed
  */
esp_err_t esp_wifi_internal_get_negotiated_channel(wifi_interface_t ifx, ubyte aid, ubyte* primary, ubyte* second);
...
/**
  ...
  *    - ESP_OK: succeed
  */
esp_err_t esp_wifi_internal_get_negotiated_bandwidth(wifi_interface_t ifx, ubyte aid, ubyte* bw);

static if (is(typeof(SOC_WIFI_HW_TSF))) // TODO: Not yet imported
{
    /**
      ...
      *    - false: Not active
      */
    bool esp_wifi_internal_is_tsf_active();

    /**
      * @brief     Update WIFI light sleep wake ahead time
      *
      */
    void esp_wifi_internal_update_light_sleep_wake_ahead_time(uint);
    ...
    /**
      ...
      *    - false: Not active
      */
    esp_err_t esp_wifi_update_tsf_tick_interval();
}
 ...
 */
void esp_wifi_power_domain_off();

static if (is(typeof(CONFIG_MAC_BB_PD)))
{
    /**
...
/**
  ...
  */
alias wifi_tx_done_cb_t = void function(ubyte ifidx, ubyte* data, ushort* data_len, bool txStatus);
 ...
 */
void esp_wifi_set_sleep_delay_time(uint return_to_sleep_delay);
 ...
 */
void esp_wifi_set_keep_alive_time(uint keep_alive_time);
 ...
 */
void esp_wifi_beacon_monitor_configure(bool enable, int timeout, int threshold,
    int delta_intr_early, int delta_timeout);
