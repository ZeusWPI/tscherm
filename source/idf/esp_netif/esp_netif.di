module idf.esp_netif.esp_netif;
 ...
 * @param data
 */
void esp_netif_action_start(void* esp_netif, esp_event_base_t base, int event_id, void* data);
 ...
 * @param data
 */
void esp_netif_action_stop(void* esp_netif, esp_event_base_t base, int event_id, void* data);
 ...
 * @param data
 */
void esp_netif_action_connected(void* esp_netif, esp_event_base_t base, int event_id, void* data);
 ...
 * @param data
 */
void esp_netif_action_disconnected(void* esp_netif, esp_event_base_t base, int event_id, void* data);
 ...
 * @param data
 */
void esp_netif_action_got_ip(void* esp_netif, esp_event_base_t base, int event_id, void* data);
 ...
 * @param data
 */
void esp_netif_action_join_ip6_multicast_group(void* esp_netif, esp_event_base_t base, int event_id, void* data);
 ...
 * @param data
 */
void esp_netif_action_leave_ip6_multicast_group(void* esp_netif, esp_event_base_t base, int event_id, void* data);
 ...
 * @param data
 */
void esp_netif_action_add_ip6_address(void* esp_netif, esp_event_base_t base, int event_id, void* data);
 ...
 * @param data
 */
void esp_netif_action_remove_ip6_address(void* esp_netif, esp_event_base_t base, int event_id, void* data);
 ...
 */
esp_err_t esp_netif_set_mac(esp_netif_t* esp_netif, ubyte* mac);
 ...
 *         - ESP_ERR_NOT_SUPPORTED - mac not supported on this interface
 */
esp_err_t esp_netif_get_mac(esp_netif_t* esp_netif, ubyte* mac);
...
esp_err_t esp_netif_dhcps_option(esp_netif_t* esp_netif, esp_netif_dhcp_option_mode_t opt_op,
    esp_netif_dhcp_option_id_t opt_id, void* opt_val, uint opt_len);
 ...
 * @param d
 */
void esp_netif_set_ip4_addr(esp_ip4_addr_t* addr, ubyte a, ubyte b, ubyte c, ubyte d);
...
*/
uint esp_ip4addr_aton(const char* addr);
 ...
 */
int esp_netif_get_event_id(esp_netif_t* esp_netif, esp_netif_ip_event_type_t event_type);
 ...
 */
size_t esp_netif_get_nr_of_ifs();
 ...
 */
alias esp_netif_callback_fn = esp_err_t function(void* ctx);
