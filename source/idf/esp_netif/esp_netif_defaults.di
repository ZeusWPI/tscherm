...
// static if (is(typeof(CONFIG_LWIP_ESP_MLDV6_REPORT)))
//     enum ESP_NETIF_DEFAULT_MLDV6_REPORT_FLAGS = ESP_NETIF_FLAG_MLDV6_REPORT;
// else
//     enum ESP_NETIF_DEFAULT_MLDV6_REPORT_FLAGS = 0;
...
static if (is(typeof(CONFIG_ESP_WIFI_SOFTAP_SUPPORT)))
{
...
static if (is(typeof(CONFIG_OPENTHREAD_ENABLED)))
{
    /**
    * @brief  Default configuration reference of SLIP client
    */
